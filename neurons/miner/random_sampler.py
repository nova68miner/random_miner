...
from neurons.validator.validity import validate_molecules_sampler
from combinatorial_db.reactions import (
    get_reaction_info, 
    get_smiles_from_reaction
)
from utils import get_smiles, find_chemically_identical
...
def run_sampler(n_samples: int = 1000, seed: int = None, subnet_config: dict = None, output_path: str = None, save_to_file: bool = True):
    db_path = os.path.join(NOVA_DIR, "combinatorial_db", "molecules.sqlite")
    ...
    # TODO: change random reaction choice the one determined in get_challenge_params_from_blockhash
